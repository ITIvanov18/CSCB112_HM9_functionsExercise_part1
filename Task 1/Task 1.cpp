...
/*
Задача 1. Съставете С++ функции за работа с едномерен масив за:
A. Изтриване на елемент от масив;
B. Добавяне на елемент в края на масив;
C. Добавяне на елемент на избрана позиция в масив;
D. Промяна на стойност на избран елемент.
*/
