...
/*
Задача 2. Да се напише програма на С++, която да поддържа списък с факултетни
номера на студенти. Поддържането на списък включва операциите: добавяне на
студент, изтриване на студент, промяна на факултетен номер, намиране на студент
по факултетен номер. В програмата да се използват функциите от задача 1.
*/
